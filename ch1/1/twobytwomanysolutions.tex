...
\def\xstretch{2}
    ...
    coil/.style 2 args={decoration={coil, segment length=#1, amplitude=#2},decorate,color=tulip}
        ...
        \draw[<->,domain=-2:\xmax,samples=400,smooth,variable=\x,color=pantone2727,very thick] plot ({\x},{-\x + 3});
        %\draw[<->,domain=-1:\xmax,samples=400,smooth,variable=\x,color=pantone2727,thick] plot ({\x},{\x - 1});

        \node[color=black,below] at (0,\ymax + 1) {\large Infinitely Many Solutions};
